...
function parsePartialJson(jsonText) {
  ...
  try {
    return {
      value: import_secure_json_parse2.default.parse(jsonText),
      state: "successful-parse"
    };
  } catch (ignored) {
    try {
      return {
        value: import_secure_json_parse2.default.parse(fixJson(jsonText)),
...
async function processDataProtocolResponse({
  ...
  for await (const { type, value } of readDataStream(reader, {
    ...
    if (type === "tool_call_streaming_start") {
      ...
      const toolInvocations = (_a15 = prefixMap.text) == null ? void 0 : _a15.toolInvocations;
...
var getStreamedResponse = async (api, chatRequest, mutate2, mutateStreamData, existingDataRef, extraMetadataRef, messagesRef, abortControllerRef, generateId2, streamProtocol, onFinish, onResponse, onToolCall, sendExtraMessageFields, experimental_prepareRequestBody, fetch2, keepLastMessageOnError) => {
  var _a15;
  ...
  return await callChatApi({
    api,
    body: (_a15 = experimental_prepareRequestBody == null ? void 0 : experimental_prepareRequestBody({
      ...
      try {
        ...
        await processChatStream({
          getStreamedResponse: () => getStreamedResponse(
            ...
            throttle(mutate2, throttleWaitMs),
...
function useCompletion({
  ...
  const triggerRequest = (0, import_react6.useCallback)(
    async (prompt2, options) => callCompletionApi({
      api,
      prompt: prompt2,
      credentials: extraMetadataRef.current.credentials,
  ...
  const complete = (0, import_react6.useCallback)(
    async (prompt2, options) => {
      return triggerRequest(prompt2, options);
    },
    [triggerRequest]
  );
